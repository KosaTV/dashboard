        ...
        <div className="mx-auto flex max-w-[1600px] items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              className="gap-1.5 border-slate-200 text-xs bg-transparent"
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Button
                    variant="outline"
                    size="icon"
                    className="h-10 w-10 shrink-0 border-slate-200 bg-transparent"
              ...
              <div className="flex-1">
                ...
                <div className="mb-8 flex items-center gap-8 text-sm text-slate-600">
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-slate-900">X5</span>
                  </div>
                  <div>
                ...
                <div className="rounded-lg border border-slate-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-700">
                    Customer is comparing two similar X5s, one is a year older but has more features; interested
                    in a newer plate, has owned several X5s before, not interested in shopping around
                    extensively.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-10">
              ...
              <p className="text-sm leading-relaxed text-slate-700">
                Customer comparing two BMW X5s (one at Williams, one in Glasgow), provided reg for comparison,
                wants a one-time best offer; rep to consult manager and call back.
              </p>
            </div>
